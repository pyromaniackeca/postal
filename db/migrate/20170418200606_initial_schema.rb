class InitialSchema < ActiveRecord::Migration[4.2]
  def up
    ...
    create_table "additional_route_endpoints", force: :cascade do |t|
      t.integer  "route_id"
    ...
    create_table "address_endpoints", force: :cascade do |t|
      t.integer  "server_id"
      t.string   "uuid"
      t.string   "address"
    ...
    create_table "http_endpoints", force: :cascade do |t|
      t.integer  "server_id"
      t.string   "uuid"
      t.string   "name"
      t.string   "url"
    ...
    create_table "ip_pool_rules", force: :cascade do |t|
      t.string   "uuid"
      t.string   "owner_type"
      t.integer  "owner_id"
      t.integer  "ip_pool_id"
    ...
    create_table "organization_ip_pools", force: :cascade do |t|
    ...
    create_table "smtp_endpoints", force: :cascade do |t|
      t.integer  "server_id"
      t.string   "uuid"
      t.string   "name"
      t.string   "hostname"
    ...
    create_table "track_certificates", force: :cascade do |t|
      t.string   "domain"
    ...
    create_table "track_domains", force: :cascade do |t|
      t.string   "uuid"
      t.integer  "server_id"
      t.integer  "domain_id"
      t.string   "name"
